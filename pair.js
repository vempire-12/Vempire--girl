        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    const sessionId = "Vempire-Girl~" + base64;
                    ...
                    const successMsg = {
                        text:
                            ...
                            `_Powered by Vempire-Gurl\n\n` +
                            `🔗 *Useful Links:*\n` +
                            `▸ GitHub: https://github.com/vempire-12/Vempire-girl_MD\n` +
                            `▸ https://whatsapp.com/channel/0029Vb6hlhSLSmbT1Qb5x633`,
                        contextInfo: {
